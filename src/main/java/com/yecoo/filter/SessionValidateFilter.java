...
public class SessionValidateFilter implements Filter {
	...
	public void doFilter(ServletRequest request, ServletResponse response,
		...
		String serverName = StrUtils.nullToStr(httpServletRequest
				.getServletPath());
		if (!serverName.equals("/") && !serverName.equals("/login")// 登录
				&& !serverName.equals("/loginDialog")// 对话框登录
				&& !serverName.equals("/logout")// 登出
				&& serverName.indexOf("/www/") == -1// 网站
				&& serverName.indexOf("/images/") == -1// 图片
				&& serverName.indexOf("/resources/picture/") == -1// 图片
			) {
